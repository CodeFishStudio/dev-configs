 ...
 */
export const copyAgentSkills = (selectedSkillIds) => {
    ...
    try {
        ...
        if (totalCopied > 0) {
            logStep(`Installed ${totalCopied} agent skill file${totalCopied === 1 ? '' : 's'}`, 'success');
        }
    }
    catch (error) {
...
//# sourceMappingURL=copyAgentSkills.js.map