...
export declare const prettierScripts: readonly [{
    ...
    readonly command: "{{PACKAGE_MANAGER}} ./node_modules/prettier/bin/prettier.cjs . --write --cache --log-level=error";
}, {
    readonly name: "format:check";
    readonly command: "{{PACKAGE_MANAGER}} ./node_modules/prettier/bin/prettier.cjs . --check";
}];
